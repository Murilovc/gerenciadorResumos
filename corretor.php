    ...
    <body>
        ...
        ?>
            ...
            <div style="float: left">
                ...
                <iframe src="arquivos/<?php echo $local;?>" width="1150px" height="535px">
                </iframe>
            ...
            <div style="float: left;">
                <form action="back-end/comentario/CadastroComentario.php" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <textarea rows="7" cols="20" name="texto" type="text" class="form-control" id="inputComentario" placeholder="Comentários"></textarea>

                        <input type="hidden" name="fk_id_avaliador" value="<?php echo $id_avaliador?>">
                        
                        <input type="hidden" name="fk_id_resumo" value="<?php echo $id_resumo?>">
